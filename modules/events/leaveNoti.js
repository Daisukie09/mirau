module.exports.config = {
	...
	description: "Notification when bot or user leaves the group with random gif/image/video",
	dependencies: {
		"fs-extra": "",
		"path": ""
	}
...
module.exports.run = async function ({ api, event, Users, Threads }) {
	...
	const type = (event.author == event.logMessageData.leftParticipantFbId) ? "Left" : "Kicked from Group";
	const path = join(__dirname, "cache", "leaveGif","randomgif");
	...
	(typeof data.customLeave == "undefined") ? msg = "🐶 {name} has {type} !!!\n📎 Url: m.me/{iduser}\n⏰ Time out: {session} || {time}\n📅 Date out: {fullYear}" : msg = data.customLeave;
	msg = msg
    ...
    // Recall message after 10 seconds
    setTimeout(() => {
