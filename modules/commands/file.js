module.exports.config = {
  ...
  description: 'view items in folder, delete, view file',
...
module.exports.handleReply = function( {
  ...
  try {
      ...
      switch (action) {
          ...
          case 'del': {
              ...
              api.sendMessage(`✅ Deleted ${!!fo && !!fi ? `${fo}. ${fi}`: !!fo?fo: !!fi?fi: null}:\n\n${arrFile.join('\n')}`, event.threadID, event.messageID);
          };
              break;
          case 'send':
          ...
          case "create": {
              ...
              api.sendMessage(`✅ Created ${['folder', 'file'][t]} path: ${event.args[1]}`, event.threadID, event.messageID);
          };
              break;
          case 'copy':
          ...
          case 'rename': {
              ...
              if (!new_path)return api.sendMessage('❎ No new path entered', event.threadID, event.messageID);
          ...
          case 'zip':
              ...
              break;
          default:
              api.sendMessage(`❎ Reply [open | send | del | view | create | zip | copy | rename] + index`, event.threadID, event.messageID);
          };
      }catch(e) {
          console.error(e);
  ...
  function openFolder(a, b, c) {
      ...
      txt += `\n📊 Total directory size: ${convertBytes(bytes_dir)}\nReply [open | send | del | view | create | zip | copy | rename] + index`
