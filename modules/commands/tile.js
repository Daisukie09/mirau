module.exports.config = {
    name: "tile", //match percentage
    version: "1.0.2",
    hasPermssion: 2,
    credits: "⚡️D-Jukie",
    description: "View match percentage between 2 people",
...
module.exports.run = async function({ api, args, Users, event }) {
    ...
    if (mentions.length < 2) return api.sendMessage("You need to tag 2 people you want to see the match percentage of", event.threadID);
    ...
    var msg = {
        body: `⚡️Love match percentage between ${name1} and ${name2} is ${tle}% 🥰`,
        mentions: arraytag,
        attachment: imglove
    };
