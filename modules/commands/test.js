module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "DC-Nam",
    description: "Download video from Facebook video link",
...
module.exports.run = async ({
    ...
    while (!args[0]) return api.sendMessage("[⚜️]➜ Missing link", event.threadID, event.messageID);
    ...
    return api.sendMessage("[⚜️]➜ Downloading...please wait a moment!!", event.threadID, async (err, info) => {
