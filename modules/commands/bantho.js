module.exports.config = {
	...
	description: "Altar image of the tagged person",
...
try {
  ...
  const canvas = Canvas.createCanvas(960, 634);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "Oh hey, you okay ?:))"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
