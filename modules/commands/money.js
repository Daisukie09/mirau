module.exports.config = {
 ...
 commandCategory: "Money/Earn Money",
  cooldowns: 5,
  envConfig: {
...
module.exports.run = async ({ event, api, Currencies, Users }) => {
  ...
  api.sendMessage(`Name: ${(await Users.getData(uid)).name}\nCurrent balance: ${Number((await Currencies.getData(uid)).money)} VND`,threadID)
}