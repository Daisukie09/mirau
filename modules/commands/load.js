module.exports.config = {
  ...
  hasPermssion: 3,
  credits: "Quất",
  description: "Load commands like cmd but faster",
    ...
    for (const nameModule of moduleList) {
        try {
            ...
            if (command.config.dependencies && typeof command.config.dependencies == 'object') {
                ...
                for (const packageName in command.config.dependencies) {
                    ...
                    try {
                        ...
                        logger.loader('Package not found ' + packageName + ' supporting command ' + command.config.name+ ' proceeding to install...', 'warn');
                        const insPack = {};
            ...
            if (command.config.envConfig && typeof command.config.envConfig == 'Object') try {
                ...
                throw new Error('⚠️ Cannot load config module, error: ' + JSON.stringify(error));
            }
            if (command['onLoad']) try {
                ...
                throw new Error('⚠️ Cannot onload module, error: ' + JSON.stringify(error), 'error');
            }
